...
If you want more specialized event registration options like event bookings, be sure to try out our other plugin [EventPrime](https://wordpress.org/plugins/eventprime-event-calendar-management/). It integrates with RegistrationMagic to display RegistrationMagic's user registration forms when users book tickets for an event.
...
* Info: Forms built using version 5.0.2.4 and below will continue to work using old builder.
...
= 5.2.2.2 =
New features for standard users and other additions.

= 5.2.2.1 =
Minor UI improvements.

= 5.2.2.0 =
Minor UI and functionality improvements.

= 5.2.1.9 =
Minor UI improvements.

= 5.2.1.8 =
Multiple small enhancements to improve usability.

= 5.2.1.7 =
This release fixes compatibility issues with access control plugins. It also allows hiding payment selection options on payment forms.
...
= 4.5.7.4 =
* We made it easier for you to add form field data to User Meta.
