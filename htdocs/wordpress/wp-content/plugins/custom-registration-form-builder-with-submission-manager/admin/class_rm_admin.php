...
class RM_Admin {
   ...
   version="1.1"><metadata
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script( 'rm-license', RM_BASE_URL . 'admin/js/rm-license.js', array( 'jquery',), $this->version, true );
        wp_localize_script(
                                        'rm-license',
        ...
        if (!class_exists("AAM")){
            ...
            if(!RM_Utilities::fatal_errors()) {
                ...
                if (current_user_can("top_admin_show")){
                    ...
                    foreach ($admin_order as $value) {
                        ...
                        if ($value[3] == "visible"){
                            ...
                            if ($value[0] == 'rm_form_manage') {
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETUP'), RM_UI_Strings::get('ADMIN_MENU_SETUP'), $value[0]."manage_options", "rm_form_setup", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETUP'), RM_UI_Strings::get('ADMIN_MENU_SETUP'), $value[0]."manage_options", "rm_form_setup_finished", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_IMPORT'), RM_UI_Strings::get('ADMIN_MENU_FS_IMPORT'), $value[0]."manage_options", "rm_form_import", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_MNG_FIELDS_PT'), RM_UI_Strings::get('ADMIN_MENU_MNG_FIELDS_PT'), $value[0]."manage_options", "rm_field_manage", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_VIEW_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_VIEW_PT'), $value[0]."manage_options", "rm_form_sett_view", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_NEWFORM_PT'), RM_UI_Strings::get('ADMIN_MENU_NEWFORM_PT'), $value[0]."manage_options", "rm_form_sett_general", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_ACC_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_ACC_PT'), $value[0]."manage_options", "rm_form_sett_accounts", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_PST_SUB_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_PST_SUB_PT'), $value[0]."manage_options", "rm_form_sett_post_sub", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_AR_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_AR_PT'), $value[0]."manage_options", "rm_form_sett_autoresponder", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_LIM_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_LIM_PT'), $value[0]."manage_options", "rm_form_sett_limits", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_ET_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_ET_PT'), $value[0]."manage_options", "rm_form_sett_email_templates", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_MC_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_MC_PT'), $value[0]."manage_options", "rm_form_sett_mailchimp", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), $value[0]."manage_options", "rm_sent_emails_manage", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_ADD_FIELD_PT'), RM_UI_Strings::get('ADMIN_MENU_ADD_FIELD_PT'), $value[0]."manage_options", "rm_field_add", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_PT'), $value[0]."manage_options", "rm_form_sett_manage", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_AW_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_AW_PT'), $value[0]."manage_options", "rm_form_sett_aweber", array($this->get_controller(), 'run'));
                                
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_ACTRL_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_ACTRL_PT'), $value[0]."manage_options", "rm_form_sett_access_control", array($this->get_controller(), 'run'));
                                
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_OV_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_OV_PT'), $value[0]."manage_options", "rm_form_sett_override", array($this->get_controller(), 'run'));
                                
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_FS_CC_PT'), RM_UI_Strings::get('ADMIN_MENU_FS_CC_PT'), $value[0]."manage_options", "rm_form_sett_ccontact", array($this->get_controller(), 'run'));
                                
                                add_submenu_page("", 'Login Dashboard', 'Login Dashboard', $value[0]."manage_options", "rm_login_sett_manage", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Fields', 'Login Fields', $value[0]."manage_options", "rm_login_field_manage", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Fields', 'Login Fields', $value[0]."manage_options", "rm_login_field_add", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Fields', 'Login Fields', $value[0]."manage_options", "rm_login_field_view_sett", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Logged in View', 'Logged in View', $value[0]."manage_options", "rm_login_view", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Redirections', 'Login Redirections', $value[0]."manage_options", "rm_login_sett_redirections", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Validation & Security', 'Login Validation & Security', $value[0]."manage_options", "rm_login_val_sec", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Password Recovery', 'Password Recovery', $value[0]."manage_options", "rm_login_recovery", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Two Factor Authentication', 'Two Factor Authentication', $value[0]."manage_options", "rm_login_two_factor_auth", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Email Templates', 'Email Templates', $value[0]."manage_options", "rm_login_email_temp", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Third Part Integrations', 'Third Part Integrations', $value[0]."manage_options", "rm_login_integrations", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Login Analytics', 'Login Analytics', $value[0]."manage_options", "rm_login_analytics", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Log Retention', 'Log Retention', $value[0]."manage_options", "rm_login_retention", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Advanced Log', 'Advanced Log', $value[0]."manage_options", "rm_login_advanced", array($this->get_controller(), 'run'));
                                ...
                                //add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETUP'), RM_UI_Strings::get('ADMIN_MENU_SETUP'), "manage_options", "rm_form_setup", array($this->get_controller(), 'run'));

                            } elseif($value[0] == 'rm_form_manage_cstatus') {
                                add_submenu_page("rm_form_manage", $menu_title, $menu_title, $value[0]."manage_options", $value[0], array($this->get_controller(), 'run'));
                                add_submenu_page("", 'Add Custom Status', 'Add Custom Status', $value[0]."manage_options", "rm_form_add_cstatus", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_VIEW_SUB_PT'), RM_UI_Strings::get('ADMIN_MENU_VIEW_SUB_PT'), $value[0]."manage_options", "rm_submission_view", array($this->get_controller(), 'run'));
                                ...
                                */
                                // Attachments options
                                //add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), $value[0]."manage_options", "rm_options_general", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_ATT_DL_PT'), RM_UI_Strings::get('ADMIN_MENU_ATT_DL_PT'), $value[0]."manage_options", "rm_attachment_download", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REG_PT'), RM_UI_Strings::get('ADMIN_MENU_REG_PT'), $value[0]."manage_options", "rm_user_view", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_ADD_PP_FIELD_PT'), RM_UI_Strings::get('ADMIN_MENU_ADD_PP_FIELD_PT'), $value[0]."manage_options", "rm_paypal_field_add", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('PAYMENTS_VIEW_MENU'), RM_UI_Strings::get('PAYMENTS_VIEW_MENU'), $value[0]."manage_options", "rm_payments_view", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_ADD_NOTE_PT'), RM_UI_Strings::get('ADMIN_MENU_ADD_NOTE_PT'), $value[0]."manage_options", "rm_note_add", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), $value[0]."manage_options", "rm_reports_submissions", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), $value[0]."manage_options", "rm_reports_login", array($this->get_controller(), 'run'));

                                if (class_exists('Registration_Magic_Addon')){

                                    add_submenu_page("", 'Attachments Reports', 'Attachments Reports', $value[0]."manage_options", "rm_reports_attachments", array($this->get_controller(), 'run'));

                                    add_submenu_page("", 'Payments Reports', 'Payments Reports', $value[0]."manage_options", "rm_reports_payments", array($this->get_controller(), 'run'));

                                    add_submenu_page("", 'Compare Form Reports', 'Compare Forms Reports', $value[0]."manage_options", "rm_reports_form_compare", array($this->get_controller(), 'run'));

                                    add_submenu_page("", 'Notifications Reports', 'Notifications Reports', $value[0]."manage_options", "rm_reports_notifications", array($this->get_controller(), 'run'));

                                    add_submenu_page("", 'Add Notifications Reports', 'Notifications Reports', $value[0]."manage_options", "rm_reports_notification_add", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_FAB_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_FAB_PT'), $value[0]."manage_options", "rm_options_fab", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_AS_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), $value[0]."manage_options", "rm_options_security", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_UA_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_UA_PT'), $value[0]."manage_options", "rm_options_user", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_AR_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_TP_PT'), $value[0]."manage_options", "rm_options_autoresponder", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_TP_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_TP_PT'), $value[0]."manage_options", "rm_options_thirdparty", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_PP_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_PP_PT'), $value[0]."manage_options", "rm_options_payment", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_PP_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_PP_PT'), $value[0]."manage_options", "rm_options_default_pages", array($this->get_controller(), 'run'));

                                add_submenu_page("", __('User Privacy', 'custom-registration-form-builder-with-submission-manager'), __('User Privacy', 'custom-registration-form-builder-with-submission-manager'), $value[0]."manage_options", "rm_options_user_privacy", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'Advance Options', 'Advance Options', $value[0]."manage_options", "rm_options_advance", array($this->get_controller(), 'run'));

                                add_submenu_page("", 'ProfileGrid', 'ProfileGrid', $value[0]."manage_options", "rm_form_sett_profilegrid", array($this->get_controller(), 'run'));

                                if (current_user_can( "manage_options" )){

                                    add_submenu_page("", RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), $value[0]."manage_options", "rm_options_admin_menu", array($this->get_controller(), 'run'));

                                }

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), $value[0]."manage_options", "rm_options_tabs", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('PAYMENTS_INVOICE_SETTING_MENU'), RM_UI_Strings::get('PAYMENTS_INVOICE_SETTING_MENU'), $value[0]."manage_options", "rm_options_manage_invoice", array($this->get_controller(), 'run'));

                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_CTABS'), RM_UI_Strings::get('ADMIN_MENU_CTABS'), $value[0]."manage_options", "rm_options_manage_ctabs", array($this->get_controller(), 'run'));

                                if (class_exists('Registration_Magic_Addon')){
                                    add_submenu_page("", 'Add Custom Tabs', 'Add Custom Tabs', $value[0]."manage_options", "rm_options_add_ctabs", array($this->get_controller(), 'run')); 
                                }
                                    ...
                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), $value[0]."manage_options", "rm_sent_emails_view", array($this->get_controller(), 'run'));
                                } else {
                            ...
                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_PP_PROC_PT'), "", $value[0]."manage_options", "rm_paypal_proc", array($this->get_controller(), 'run'));

                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_VIEW_SUB_RELATED'), RM_UI_Strings::get('ADMIN_MENU_VIEW_SUB_RELATED'), $value[0]."manage_options", "rm_submission_related", array($this->get_controller(), 'run'));

                            //add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), RM_UI_Strings::get('ADMIN_MENU_SENT_MAILS'), $value[0]."manage_options", "rm_sent_emails_view", array($this->get_controller(), 'run'));

                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_SAVE_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_SAVE_PT'), $value[0]."manage_options", "rm_options_save", array($this->get_controller(), 'run'));

                            

                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), $value[0]."manage_options", "rm_support_forum", array($this->get_controller(), 'run'));

                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_USER_ROLE_DEL_PT'), RM_UI_Strings::get('ADMIN_MENU_USER_ROLE_DEL_PT'), $value[0]."manage_options", "rm_user_role_delete", array($this->get_controller(), 'run'));

                            add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_ADD_FIELD_PT'), RM_UI_Strings::get('ADMIN_MENU_ADD_FIELD_PT'), $value[0]."manage_options", "rm_field_add_widget", array($this->get_controller(), 'run'));
                            ...
                            if (current_user_can( "manage_options" )){
                                ...
                                if ($value[0] == 'rm_form_manage') {
                                    ...
                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETUP'), RM_UI_Strings::get('ADMIN_MENU_SETUP'), "manage_options", "rm_form_setup_finished", array($this->get_controller(), 'run'));
                                    ...
                                    add_submenu_page("", RM_UI_Strings::get('PAYMENTS_VIEW_MENU'), RM_UI_Strings::get('PAYMENTS_VIEW_MENU'), "manage_options", "rm_payments_view", array($this->get_controller(), 'run'));
                                    ...
                                    add_submenu_page("", $menu_title, $menu_title, "manage_options", $value[0], array($this->get_controller(), 'run'));
                                    ...
                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), "manage_options", "rm_reports_submissions", array($this->get_controller(), 'run'));

                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), "manage_options", "rm_reports_login", array($this->get_controller(), 'run'));

                                    if (class_exists('Registration_Magic_Addon')){

                                        add_submenu_page("", 'Attachments Reports', 'Attachments Reports', "manage_options", "rm_reports_attachments", array($this->get_controller(), 'run'));

                                        add_submenu_page("", 'Payments Reports', 'Payments Reports', "manage_options", "rm_reports_payments", array($this->get_controller(), 'run'));

                                        add_submenu_page("", 'Compare Form Reports', 'Compare Forms Reports', "manage_options", "rm_reports_form_compare", array($this->get_controller(), 'run'));

                                        add_submenu_page("", 'Notifications Reports', 'Notifications Reports', "manage_options", "rm_reports_notifications", array($this->get_controller(), 'run'));

                                        add_submenu_page("", 'Add Notifications Reports', 'Notifications Reports', "manage_options", "rm_reports_notification_add", array($this->get_controller(), 'run'));
                                    ...
                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_CTABS'), RM_UI_Strings::get('ADMIN_MENU_CTABS'), "manage_options", "rm_options_manage_ctabs", array($this->get_controller(), 'run'));

                                    if (current_user_can( "manage_options" )){

                                        add_submenu_page("", RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), RM_UI_Strings::get('ARRANGE_ADMIN_MENU'), "manage_options", "rm_options_admin_menu", array($this->get_controller(), 'run'));

                                    }

                                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), RM_UI_Strings::get('ADMIN_MENU_SETTING_GEN_PT'), "manage_options", "rm_options_tabs", array($this->get_controller(), 'run'));

                                    add_submenu_page("", RM_UI_Strings::get('PAYMENTS_INVOICE_SETTING_MENU'), RM_UI_Strings::get('PAYMENTS_INVOICE_SETTING_MENU'), "manage_options", "rm_options_manage_invoice", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), "manage_options", "rm_support_forum", array($this->get_controller(), 'run'));
                                ...
                                add_submenu_page("", __('Licensing', 'custom-registration-form-builder-with-submission-manager'), __('Licensing', 'custom-registration-form-builder-with-submission-manager'), "manage_options", "rm_licensing", array($this, 'rm_licensing'));
                    ...
                    if(!defined('REGMAGIC_ADDON') && current_user_can("manage_options")) {

                        //$settingPosition = array_search( "rm_options_manage", array_column( $submenu[ "rm_form_manage" ], 2 ) );

                        //$submenu[ 'rm_form_manage' ][$settingPosition][4] = "rm-show-divider";
                    ...
                    // add_submenu_page("rm_form_manage", RM_UI_Strings::get('ADMIN_MENU_CSTATUS'), RM_UI_Strings::get('ADMIN_MENU_CSTATUS'), "manage_options", "rm_form_manage_cstatus", array($this->get_controller(), 'run'), 3);
                    ...
                    // add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_INV'), RM_UI_Strings::get('ADMIN_MENU_INV'), "manage_options", "rm_invitations_manage", array($this->get_controller(), 'run'));
                    ...
                    //add_submenu_page("rm_form_manage", RM_UI_Strings::get('ADMIN_MENU_REPORTS'), RM_UI_Strings::get('ADMIN_MENU_REPORTS'), "manage_options", "rm_reports_dashboard", array($this->get_controller(), 'run'));
            ...
            if (current_user_can('manage_options')) {
                ...
                if(!RM_Utilities::fatal_errors()) {
                    ...
                    /* Reports Menus */ 
                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS'), RM_UI_Strings::get('ADMIN_MENU_REPORTS'), "manage_options", "rm_reports_dashboard", array($this->get_controller(), 'run'));
                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_SUB'), "manage_options", "rm_reports_submissions", array($this->get_controller(), 'run'));
                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), RM_UI_Strings::get('ADMIN_MENU_REPORTS_LOGIN'), "manage_options", "rm_reports_login", array($this->get_controller(), 'run'));
    ...
    public function deactivate_license(){
        ...
        $retrieved_nonce = filter_input( INPUT_POST, 'nonce' );
            ...
            $rm_license_deactivate = sanitize_text_field(filter_input( INPUT_POST, 'rm_license_deactivate' ));
            $license_key = sanitize_text_field(filter_input( INPUT_POST, 'rm_license' ));
            $item_id = sanitize_text_field(filter_input( INPUT_POST, 'rm_item_id' ));
            $item_key = sanitize_text_field(filter_input( INPUT_POST, 'rm_item_key' ));
            update_option( $item_key.'_license_key', $license_key );
            update_option( $item_key.'_license_id', $item_id );
            $response = array();
            if( isset( $rm_license_deactivate ) && ! empty( $rm_license_deactivate ) ){
                $license = new RM_Licensing();
