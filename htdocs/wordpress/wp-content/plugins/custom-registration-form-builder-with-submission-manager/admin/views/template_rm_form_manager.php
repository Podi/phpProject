...
if (($rm_env_requirements & RM_REQ_EXT_CURL) && $data->newsletter_sub_link){ ?>
 <div class="rm-newsletter-banner" id="rm_newsletter_sub"><?php echo wp_kses_post((string)$data->newsletter_sub_link);?><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/close-rm.png'); ?>" onclick="jQuery('#rm_newsletter_sub').hide()"></div>
 <?php } ?>
                    ...
                    <div class="rm-box-col-12 rm-box-white-bg rm-form-box">                       
                        <div class="rm-modal-titlebar rm-new-form-popup-header">
                                <div class="rm-modal-title">
                                    <?php _e('Add New Form', 'custom-registration-form-builder-with-submission-manager'); ?>
                                </div>
        ...
        <div class="sidebanner-content-wrapper">
            ...
            <div class="rm-sidebanner-buttons">
                <div class="rm-sidebanner-button">
                    <a target="_blank" href="https://wordpress.org/support/plugin/custom-registration-form-builder-with-submission-manager/"><?php _e('Create Support Ticket','custom-registration-form-builder-with-submission-manager'); ?></a>			
                </div>
