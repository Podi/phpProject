        ...
        <div class="rmagic rmagic-wide rm-user-manager">
            ...
            <form id="rm_user_manager_sideform" action="<?php echo esc_url(add_query_arg('rm_reqpage', '1')); ?>" method="GET">
                ...
                <ul class="subsubsub">
                    ...
                    <input type="hidden" name="rm_sort" value="<?php echo isset($_GET['rm_sort']) ? sanitize_text_field($_GET['rm_sort']) : 'latest';?>"/>
                            ...
                            if (!empty($data->users) && is_array($data->users) || is_object($data->users)) {
                                foreach ($data->users as $user):
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo date('M d, Y @ h:i a', strtotime($user->user_registered)); ?></td>
                                        <td class="">
                                            <?php
                                            $last_login = '';
