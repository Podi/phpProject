...
<form action="" id="rm_form_add_new_form" method="post" class="form-horizontal">
    ...
    <div class="rm-create-new-from">
            <div class="rm-form-name rm-dbfl"> 
                ...
                <div class="rm-text-end rm-inline-block rm-box-w-100"><a href="javascript:void(0)" onclick="showOptionalSetting()" class="rm-text-small rm-optional-setting-toggle">
