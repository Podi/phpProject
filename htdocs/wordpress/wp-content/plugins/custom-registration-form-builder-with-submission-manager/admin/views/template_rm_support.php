    ...
    <div class="rm-support-container">
        ...
        <div class="rm-support-block rm-difl">
            <div class="rm-support-block-head rm-dbfl">
                ...
                <div class="rm-support-block-icon rm-difl"> <img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-support-resources.png'); ?>"></div>
                ...
                <div class="rm-support-col">
                    ...
                    <div class="rm-support-col-row rm-support-col-head"><?php _e('Contact Us', 'custom-registration-form-builder-with-submission-manager'); ?></div>
                        <div class="rm-support-col-row">
                            <div class="rm-support-col-subhead"><a href="https://wordpress.org/support/plugin/custom-registration-form-builder-with-submission-manager/#new-topic-0" target="_blank"><?php _e('Ask a Question', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
                            <div class="rm-support-text"><?php _e('Post on official RegistrationMagic WordPress forums.', 'custom-registration-form-builder-with-submission-manager'); ?></div>
                        </div>

                        <div class="rm-support-col-row">
                            <div class="rm-support-col-subhead"><a href="https://registrationmagic.com/help-support/" target="_blank"><?php _e('Get Technical Help', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
                        ...
                        <div class="rm-support-col-row">
                            <div class="rm-support-col-subhead"><a href="https://metagauss.com/customization-help/" target="_blank"><?php _e('Request Custom Solution', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
                        ...
                        <div class="rm-support-col-row">
                            <div class="rm-support-col-subhead"><a href="https://registrationmagic.com/translate-wordpress-plugins/" target="_blank"><?php _e('Translate', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
                            <div class="rm-support-text"><?php _e('Help us improve RegistrationMagic by translating it in your language.', 'custom-registration-form-builder-with-submission-manager'); ?></div>
                        </div>
        ...
        <div class="rm-support-block-head rm-dbfl">
                ...
                <div class="rm-support-block-icon rm-difl"> <img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-support-faq.png'); ?>"></div>
