...
wp_enqueue_script('rm_select2');
wp_enqueue_style('rm_select2');
...
$form->addElement(new Element_Textboxsortable("<b>" . RM_UI_Strings::get('LABEL_OPTIONS') . "</b>", "field_value[]", array("id" => "rm_field_value_options_sortable", "class" => "rm_static_field rm_field_value", "value" => is_array($data->model->get_field_value()) ? $data->model->get_field_value() : explode(',' , (string)$data->model->get_field_value()), "longDesc"=>RM_UI_Strings::get('HELP_ADD_FIELD_OPTIONS_SORTABLE'))));
...
$form->addElement(new Element_Number("<b>" . RM_UI_Strings::get('LABEL_MAX_LENGTH') . "</b>", "field_max_length", array("id" => "rm_field_max_length", "class" => "rm_static_field rm_text_type_field rm_input_type", "value" => $data->model->field_options->field_max_length, "min" => $data->model->field_options->field_min_length, "longDesc"=>RM_UI_Strings::get('HELP_ADD_FIELD_MAX_LEN'))));
...
$form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_IS_FIELD_EDITABLE') . "</b>", "buy_pro_1", array(1 => ""), array("id" => "rm_field_is_editable", "class" => "rm_static_field", "value" => '', "longDesc"=>RM_UI_Strings::get('HELP_LABEL_IS_FIELD_EDITABLE') . '<br><br>' . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));
...
function rm_get_help_text(ftype){
    ...
    switch(ftype)
    {
        ...
        case "<?php echo esc_html($type); ?>":return "<?php echo wp_kses_post((string)RM_UI_Strings::get("FIELD_HELP_TEXT_".$type)); ?>";        
        <?php } ?>
        default: return "<?php echo wp_kses_post((string)RM_UI_Strings::get("HELP_ADD_FIELD_SELECT_TYPE")); ?>";
    }
}
