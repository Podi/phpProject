...
/**
 * Description of UserRowsForm
 *
 * @author RegistrationMagic
 */

class View_UserRowsForm extends View {
    ...
    public function render() {
        ...
        echo '</fieldset></form>';
        do_action('rm_form_rendered', $this->_form);
    }

    public function renderElement(Element $element) {
        $ele_adv_opts = $element->getAdvanceAttr();
        $row_class = trim("rmagic-field ".$ele_adv_opts['exclass_row']);
