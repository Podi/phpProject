...
class RM_UI_Strings {
    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'MSG_BUY_PRO_ACTIONS_INLINE':
                return sprintf(__('<span class="rm_buy_pro_inline">To unlock the following custom registration actions, please upgrade <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),RM_Utilities::comparison_page_link());
            ...
            case 'MSG_BUY_PRO_PRICE_FIELDS':
                return sprintf(__('<span class="rm_buy_pro_inline">To allow users to select from a price list, or to enter their own price, please upgrade <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),RM_Utilities::comparison_page_link());
            ...
            case 'MSG_NOT_AUTHORIZED':
                return __('You must be logged in to view contents of this page.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_PAID_AMOUNT':
                return __('Total Paid Amount', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_PAID_TAX':
                return __('Tax', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_ADD_NEW_TEMPLATE':
                return __('Form Templates','custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_MIN_LENGTH':
                return __('Minimum Length', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_ADMIN_ONLY':
                return __('Editable Only by Admin', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_ENABLE_SEARCH':
                return __('Enable Search', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_PRICE':
                return __('Price (%s)', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'NO_PRICE_FIELDS_MSG':
                return __('You do not have any products yet. Select a Pricing Type above to start creating products.<br>These products can be later inserted into any form for accepting payment.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'ALERT_DELETE_FORM':
                return __('You are going to delete this form(s). This will also delete all data associated with the form(s) including submissions and payment records. Users will not be deleted. Do you want to proceed?', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'GLOBAL_SETTINGS_EXTERNAL_INTEGRATIONS_EXCERPT':
                return __('Plugin level integration options for third-party services.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_FILE_PREFIX':
                return __('File Prefix', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_FILE_SIZE':
                return __('File Size', 'custom-registration-form-builder-with-submission-manager');
            
            case 'LABEL_FILE_SIZE_ERR':
                return __('File Size Error Message', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_FACEBOOK_APP_SECRET':
            ...
            case 'LABEL_HIDE_PAYMENT_SELECTOR':
                return __('Hide Payment Processor Selection', 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_ENABLE_TAX':
                return __('Enable Tax', 'custom-registration-form-builder-with-submission-manager');
            
            case 'LABEL_TAX_TYPE':
                return __('Tax Type', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_TAX_TYPE_FIXED':
                return __('Fixed', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_TAX_TYPE_PERCENTAGE':
                return __('Percentage', 'custom-registration-form-builder-with-submission-manager');
                
            case 'LABEL_TAX_FIXED':
                return __('Fixed Tax Amount', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_ENABLE_HIDE_PAYMENT_SELECTOR':
                return __("Enable this if you don't want users to choose payment processors at the time of form submission.", 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_ENABLE_TAX_HELP':
                return __("Use this option to enable tax on form submissions with product fields.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'ERROR_CUSTOM_FILE_SIZE':
                return __('%s exceeds the file size limit of %d kBs', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_LAST_MONTH':
                return __('Last Month', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_DISPLAY_NAME':
                return __("Display Name", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'MSG_PAYMENT_SUCCESS':
                return __("Payment Successful", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_MIN_LEN':
                return sprintf(__("Minimum Allowed length (characters) of the user submitted value. Leave blank for no limit. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-field/#htminlength');
                
            case 'HELP_ADD_FIELD_ADMIN_ONLY':
                return __("Enable this option if you require this field to be only editable by the site admin. This will also hide the field for non-admin users while submitting the form.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_GEN_FILE_PREFIX':
                return __('Add any custom text here that will be prefixed to the uploaded file names.', 'custom-registration-form-builder-with-submission-manager');
                
            case 'HELP_OPTIONS_GEN_FILE_SIZE':
                return __('Add the fize size, in kilobytes (kBs), to allow users to upload attachments only upto this size. Set it to 0 to disable file size limit.', 'custom-registration-form-builder-with-submission-manager');
            
            case 'HELP_OPTIONS_GEN_FILE_SIZE_ERR':
                return __('Add your own custom error message that will appear when a user tries to upload attachment bigger than the allowed file size. Use <strong>%s</strong> as placeholder for file name. Or leave it empty to display the default file size error message.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_FB_APPSECRET':
                return __("To make Facebook login work, you’ll need an App Secret. It will be provided when you generate an App ID.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_PYMNT_TESTMODE':
                return sprintf(__("This will put RegistrationMagic payments on test mode. Useful for testing and troubleshooting payment system. Test mode only works with legacy PayPal checkout experience. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/payments/#htenabletestmode');
            ...
            case 'ADMIN_MENU_FORM_STATS':
                  return __("Analytics > <span class='rm-sub-muenu-text'>FORMS</span>", 'custom-registration-form-builder-with-submission-manager');

            case 'ADMIN_MENU_FIELD_STATS':
                  return __("Analytics > <span class='rm-sub-muenu-text'> FIELDS</span>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'ADMIN_MENU_USERS':
                return __("Users", 'custom-registration-form-builder-with-submission-manager');

            case 'ADMIN_MENU_ROLES':
                return __("Roles", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'ADMIN_SUBMENU_REG':
                return __("Forms", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FIELD_TYPE_PGAVATAR':
                return __("User Avatar (ProfileGrid)", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FIELD_HELP_TEXT_PGAvatar':
                return __('A profile image upload field bound to the ProfileGrid User Avatar image.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_NO_RELATED':
                return __("No Related Submissions Found", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FD_LABEL_PRIVIEW':
                return __("Preview", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_MIN_QUANTITY' :
                return __('Minimum Quantity', 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_MAX_QUANTITY' :
                return __('Maximum Quantity', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_PRICE_FIELD_MIN_QUANTITY' :
            ...
            case 'LABEL_USER_PAYMENT_INVOICE_EMAIL' :
                return __('Payment Invoice Email Body', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_USER_PI_MSG' :
                return __("Contents of the email with the invoice to be sent to the users. Mail merge and HTML supported.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_PUBLISH_USER_AREA':
             ...
             case 'LABEL_PUBLISH_USER_AREA_TABS':
                return __("User Area Tabs", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_USER_PAYMENT_INVOICE_EMAIL_SUB' :
                return __('Payment Invoice Email Subject', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'DASHBOARD_COUNTER':
                return __('Submission Counter','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_FORMS':
                return __('Popular Forms','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_LATEST_FORMS':
                return __('Latest Forms','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_LATEST_USERS':
                return __('Latest Users','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_COUNTER_CHART_TITLE':
                return __('Submission Counter','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_FORMS_CHART_TITLE':
                return __('Trending Forms','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_USERS_CHART_TITLE':
                return __('User Registrations','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_USERS_DAYS_CHART_TITLE':
                return __('Days','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_USERS_WEEKS_CHART_TITLE':
                return __('Weeks','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_USERS_MONTHS_CHART_TITLE':
                return __('Months','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_USERS_YEARS_CHART_TITLE':
                return __('Years','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_STATICS_TITLE':
                return __('Overall Statics','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_STATICS_SUBMISSION_TITLE':
                return __('Total Submissions','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_STATICS_FORMS_TITLE':
                return __('Total Forms','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_STATICS_USER_TITLE':
                return __('Total Users','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_ADD_NEW_LINK':
                return __('Add New','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_STATICS_USER_ROLES_TITLE':
                return __('Total User Roles','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_TITLE':
                return __('Configuration','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_LOGIN_FORM_TITLE':
                return __('Login Form Configuration','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_GENERAL_TITLE':
                return __('General Settings','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_PAYMENT_TITLE':
                return __('Payment Settings','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_MEGIC_TITLE':
                return __('Magic Popup Button','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_MAILCHIMP_TITLE':
                return __('Mailchimp Integration','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_EMAIL_TITLE':
                return __('Email Configuration','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_PRIVACY_TITLE':
                return __('Privacy Settings','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_AUTOMATION_TITLE':
                return __('Automation','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_USER_ROLE_TITLE':
                return __('User Role','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS_PRODUCT_TITLE':
                return __('Products','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_EXPORT_TITLE':
                return __('Export','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_EXPORT_SUBMISSION_BUTTON':
                return __('Submissions','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_EXPORT_FORMS_BUTTON':
                return __('Form','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SHORTCODE_TITLE':
                return __('Available Shortcode','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_MORE':
                return __('More','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_FIELDS':
                return __('Fields','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD':
                return __('Dashboard','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_IMP_SHORTCODES':
                return __('Importants Shortcodes','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_LOGIN_LOGS':
                return __('Logins','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_SETTINGS':
                return __('Settings','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_LATEST_ATTACHMENTS':
                return __('Latest Attachments','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_LATEST_PAYMENTS':
                return __('Latest Payments','custom-registration-form-builder-with-submission-manager');
            case 'DASHBOARD_ATTACHMENT_CHART_TITLE':
                 return __('File Type Counter','custom-registration-form-builder-with-submission-manager');
            case 'ADMIN_MENU_REPORTS':
                 return __('Reports','custom-registration-form-builder-with-submission-manager');
            case 'ADMIN_MENU_REPORTS_SUB':
                 return __('Submission Reports','custom-registration-form-builder-with-submission-manager');
            case 'ADMIN_MENU_REPORTS_LOGIN':
                 return __('Login Reports','custom-registration-form-builder-with-submission-manager');
            case 'REPORTS_COMPARE_TOTAL_SUBMISSION':
                 return __('Total submissions','custom-registration-form-builder-with-submission-manager');
            case 'REPORTS_COMPARE_TOTAL_PAYMENT_COMPLETED':
                 return __('Total payments completed','custom-registration-form-builder-with-submission-manager');
            case 'REPORTS_COMPARE_TOTAL_PAYMENT_PENDING':
                 return __('Total payments pending','custom-registration-form-builder-with-submission-manager');
            case 'REPORTS_COMPARE_TOTAL_PAYMENT_REFUNDED':
                 return __('Total payments refunded','custom-registration-form-builder-with-submission-manager');
            case 'REPORTS_COMPARE_TOTAL_PAYMENT_CANCELED':
                 return __('Total payments cancelled','custom-registration-form-builder-with-submission-manager');
            // Reports Email Reminders
            case 'REPORT_TITLE_EMAIL_REMINDER':
                 return __('Scheduled Email Reports','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_ADD_EMAIL_REMINDER':
                 return __('New Report','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_FORM_TITLE_LABEL':
                 return __('Select Form','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_FORM_TITLE_HELP':
                 return __('Filter records based on the form you wish to generate report for.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_LOGIN_STATUS_LABEL':
                 return __('Login Status','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_LOGIN_STATUS_HELP':
                 return __('Filter report records based on outcome of the login attempts.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_PAYMENT_STATUS_LABEL':
                 return __('Payment Status','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_PAYMENT_STATUS_HELP':
                 return __('Filter report records based on outcome of the payment. Note: If the form you selected above does not have any payment fields, the report will be empty.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_CRON_TYPE_LABEL':
                 return __('Frequency','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_CRON_TYPE_HELP':
                 return __('Define how often you wish to send out this email report.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_FIRST_EXE_LABEL':
                 return __('Starts on','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_FIRST_EXE_HELP':
                 return __('Select date and time when this report will be first sent. The frequency of subsequent reports will be calculated based on this.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_SUBJECT_LABEL':
                 return __('Email Subject','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_SUBJECT_HELP':
                 return __('Subject of the email containing this report. Use variable {{REPORT_NAME}} to insert the name of the report automatically.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_EMAIL_LABEL':
                 return __('Email Body','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_EMAIL_HELP':
                 return __('Contents of this email report. The report will be attached automatically to this email as CSV file.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_NOT_TITLE_LABEL':
                 return __('Name','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_NOT_TITLE_HELP':
                 return __('Name of your scheduled report. This can help you identify purpose of this report and can be used inside the email subject.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_TITLE_LABEL':
                 return __('Report Type','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_TITLE_HELP':
                 return __('Choose the data source for this report.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_SENT_TO_LABEL':
                 return __('Email Report To','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_SENT_TO_HELP':
                 return __('Define the recipients for this report.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_INDIVIDUALS_EMAIL_LABEL':
                 return __('Individuals Email','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_INDIVIDUALS_EMAIL_HELP':
                 return __('A comma seprated list of email addresses.','custom-registration-form-builder-with-submission-manager');
            case 'REPORT_MAIL_BODY':
                return sprintf(__("Hello, <br> <br>Your report is attached. Below are the details of this report: <br> <br> Report Name: %s<br>Number of Records: %s <br>Time Period: %s <br>Next Execution: %s <br><br> <br>If you no longer wish to receive this report in your inbox, kindly ask administrator of the website %s to turn it off.", 'custom-registration-form-builder-with-submission-manager'),'{{REPORT_NAME}}','{{COUNT}}','{{DATE_RANGE}}','{{NEXT_EXECUTION}}','{{SITE_NAME}}');
            case 'REPORT_MAIL_SUBJECT':
                return sprintf(__("Here's the summary for %s from your website!", 'custom-registration-form-builder-with-submission-manager'),'{{REPORT_NAME}}');
            case 'REPORT_ENABLE_LABEL':
                return sprintf(__("Enable", 'custom-registration-form-builder-with-submission-manager'),'{{REPORT_NAME}}');
            case 'REPORT_DISABLE_LABEL':
                return sprintf(__("Disable", 'custom-registration-form-builder-with-submission-manager'),'{{REPORT_NAME}}');    
            case 'PAYMENT_DEFAULT_LABEL':
                return __('Default Payment Method','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_DEFAULT_HELPTEXT':
                return __('select default payment method on frontend.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_MAKE_DEFAULT':
                 return __('Default','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_SELECTED_DEFAULT':
                return __('Default','custom-registration-form-builder-with-submission-manager');
            
            case 'LABEL_PAYPAL_MODERN_ENABLE':
                return __('Enable New PayPal Payment Interface', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_OPTIONS_PYMNT_PP_MODERN':
                return __('Enable this option to use pop-up for PayPal payments without having the users redirected away from forms.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_PAYPAL_BTN_COLOR':
                return __('You can change the color of button. ', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_PAYPAL_BTN_COLOR_GOLD':
                return __('GOLD', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_PAYPAL_BTN_COLOR_BLUE':
                return __('Blue', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_PAYPAL_BTN_COLOR_SILVER':
                return __('Silver', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_PAYPAL_BTN_COLOR_WHITE':
                return __('White', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_PAYPAL_BTN_COLOR_BLACK':
                return __('Black', 'custom-registration-form-builder-with-submission-manager');
                
            //Payments
            case 'TITLE_PAYMENTS_MANAGER':
                 return __('Payments','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_FILTER_TITLE':
                 return __('Filters','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_FILTER_LABEL_TIME':
                 return __('Filter by time','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_FILTER_LABEL_STATUS':
                 return __('Filter by status','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_TH_ORDER_AMOUNT':
                 return __('Order Amount','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_TH_ORDER_STATUS':
                 return __('Status','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_TH_ORDER_DATE':
                 return __('Date','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_STATUS_COMPLETED':
                 return __('Completed','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_STATUS_PENDING':
                 return __('Pending','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_STATUS_CANCELED':
                 return __('Canceled','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENT_STATUS_REFUNDED':
                 return __('Refunded','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_ENABLE_INVOICE_SETTING':
                 return __('Enable Invoice','custom-registration-form-builder-with-submission-manager');
            case 'HELP_ENABLE_INVOICE_SETTING':
                 return __('Enable invoice downloadable by the users and the admins.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_COMPANY_NAME':
                 return __('Company Name','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_COMPANY_NAME':
                 return __('Add your company name to be displayed in the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_ADDRESS':
                 return __('Company Address','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_ADDRESS':
                 return __('Add your company address to be displayed in the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_CONTACT_NO':
                 return __('Company Contact No.','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_CONTACT_NO':
                 return __('Add your company contact number to be displayed in the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_EMAIL':
                 return __('Company Email','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_EMAIL':
                 return __('Add your company email address to be displayed in the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_VAT':
                 return __('VAT Number','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_VAT':
                 return __('Add your company VAT to be displayed in the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_ENABLE_FOOTER':
                 return __('Footer','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_ENABLE_FOOTER':
                 return __('Enable the footer for the invoice..','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_TEXT_FOOTER':
                 return __('Footer Text','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_TEXT_FOOTER':
                 return __('Enter text of footer.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_LEFT_MARGIN':
                 return __('Left Margin','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_LEFT_MARGIN':
                 return __('Set PDF left margin (default: 5).','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_RIGHT_MARGIN':
                 return __('Right Margin','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_RIGHT_MARGIN':
                 return __('Set PDF right margin (default: 5).','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_TOP_MARGIN':
                 return __('Top Margin','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_TOP_MARGIN':
                 return __('Set PDF top margin (default: 5).','custom-registration-form-builder-with-submission-manager');
            
            case 'LABEL_INVOICE_LOGO':
                 return __('Logo','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_LOGO':
                 return __('Prefered size(width: 200px, height: 150px)','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_USER_DOWNLOAD':
                 return __('Enable for users','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_USER_DOWNLOAD':
                 return __('Allow users to download the invoice.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_TH':
                 return __('Invoice','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_FONT':
                 return __('Invoice font','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_FONT':
                 return __('Set invoice font family.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_FONT':
                 return __('Invoice font','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_FONT':
                 return __('Set Invoice font family.','custom-registration-form-builder-with-submission-manager');
            case 'LABEL_INVOICE_EMAIL_SENT':
                 return __('Email Invoice','custom-registration-form-builder-with-submission-manager');
            case 'HELP_INVOICE_EMAIL_SENT':
                 return __('Send invoice in an email when users complete their payment.','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENTS_MENU':
                 return __('Payments','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENTS_VIEW_MENU':
                 return __('View Payments','custom-registration-form-builder-with-submission-manager');
            case 'PAYMENTS_INVOICE_SETTING_MENU':
                 return __('View Payments','custom-registration-form-builder-with-submission-manager');
            case 'FIELD_HELP_TEXT_Activeuser':
                return __('Add field which allows users to select active users from user drop-down list.', 'custom-registration-form-builder-with-submission-manager');
            case 'TITLE_CSTATUS_MANAGER':
                return __('Custom Registration Status', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_NEW_STATUS':
                return __('New Status', 'custom-registration-form-builder-with-submission-manager');
            case 'MSG_NO_FORM_CSTATUS_MAN':
                return __('You have not created any Custom Status yet. Start creating by clicking \'New Status\' button above.', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_VIEW':
                return __('View', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_COLOR':
                return __('Color', 'custom-registration-form-builder-with-submission-manager'); 
            case 'TITLE_NEW_CSTATUS':
                return __('New Custom Status', 'custom-registration-form-builder-with-submission-manager'); 
            case 'AJX_CUSTOM_STATUS_FAIL' :
                return __("Unable to process your request. Please try again.", 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_CUSTOM_STATUS' :
                return __("Custom Status", 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_USER_SUBJECT' :
                return __("Your Submission has been updated!", 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_ADMIN_SUBJECT' :
                return __("Submission Updated", 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_STATUS_FILTERS' :
                return __("Status Filters", 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_OTHER_STATUSES':
                return __('Edit Other Statuses', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_SHOW_FRONTEND':
                return __('Show on Frontend Profile', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_OTHER_STATUS':
                return sprintf(__("Interact with other Custom Statuses. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusother');
            case 'LABEL_STATUS_ACTION':
                return __('Status Action', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_CS_EMAIL_TO_USER':
                return __('Email To User', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CS_EMAIL_USER_EN':
                return sprintf(__("Send email to User on applying this Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatususeremail');
            case 'HELP_CS_EMAIL_ADMIN_EN':
                return sprintf(__("Send email to Admin on applying this Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusadminemail');
            case 'HELP_CS_USER_ACTION':
                    return sprintf(__("Interact with the User account on applying this Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatususeract');
            case 'LABEL_CS_USER_ACTIONS_EN':
                return __('User Account Actions', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_CS_USER_ACTIONS':
                return __('User Actions', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_CS_EMAIL_TO_ADMIN':
                return __('Email To Admin', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_ATTACH_NOTE':
                return __('Attach Note', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_ATTACH_NOTE':
                return sprintf(__("Attach Admin Note to form submission on applying this Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusattnote');
            case 'HELP_NOTE_TEXT':
                return __('Contents of the note to be attached to the submission.', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_BLACKLIST':
                return __('Blacklist', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_BLACKLIST':
                return sprintf(__("Block or restore access to the user for the form on applying this Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusblacklist');
            case 'HELP_BLOCK_EMAIL':
                return __('Block the user email address associated with the submission from accessing forms.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_BLOCK_IP':
                return __('Block the user IP associated with the submission from accessing forms.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_UNBLOCK_EMAIL':
                return __('Unblock the user email address associated with the submission and allow it access to the forms.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_UNBLOCK_IP':
                return __('Unblock the user IP associated with the submission and allow it access to the forms.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CS_USER_EMAIL_BODY':
                return __('Contents of the email to be sent to the user.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CS_USER_EMAIL_SUBJECT':
                return __('Subject of the email to be sent to the user.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CS_ADMIN_EMAIL_BODY':
                return __('Contents of the email to be sent to the admin.', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CS_ADMIN_EMAIL_SUBJECT':
                return __('Subject of the email to be sent to the admin.', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_BODY':
                return __('Body', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_SUBJECT':
                return __('Subject', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_STATUSES':
                return __('Limit by Status(es)', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_CLEAR_STATUSES':
                return __('Select the statuses which should currently be applied to past user submissions to allow the user to submit this form.Press ctrl or ⌘ (in Mac) while clicking to select multiple options.', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_LIMIT_BY_CS':
                return __('Limit by Status', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_LIMIT_BY_CS':
                return __('Helptext goes here', 'custom-registration-form-builder-with-submission-manager');
            case 'ALERT_SUBMISSIOM_LIMIT_BY_STATUS':
                return __('Submission can not be done as it is restricted by admin.', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_VIEW':
                return __('View', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_ADD_CSTATUS_TITLE':
                return sprintf(__("Label for your Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatuslabel');
            case 'HELP_ADD_CSTATUS_DESC':
                return sprintf(__("Text with details of your Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusdescription');
            case 'HELP_CSTATUS_ADD_COLOR':
                return sprintf(__("Color to identify your Custom Status. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatuscolor');
            case 'HELP_STATUS_FRONTEND':
                return sprintf(__("Enabling this option will show this status on the frontend user profile if the status is applied to any of the user's submissions. <a target='_blank' class='rm-more' href='%s'>More</a>", 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/knowledgebase/new-custom-status#htcustomstatusfrontend');
            case 'LABEL_NOTE_PUBLIC':
                return __('Public note', 'custom-registration-form-builder-with-submission-manager');
            case 'HELP_LABEL_NOTE_PUBLIC':
                return __('Make note public', 'custom-registration-form-builder-with-submission-manager');
            case 'LABEL_UNBLOCK_EMAIL':
                return __("Unblock Email", 'custom-registration-form-builder-with-submission-manager');
