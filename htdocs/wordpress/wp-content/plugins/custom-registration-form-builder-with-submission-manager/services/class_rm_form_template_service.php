...
Phone: 900000000 contact@registrationmagic.com', 'I accept the terms of service.');
    ...
    public function create_contact_template_c9($form_id){
        //Name   
        $field_first_id = $this->create_template_text_field($form_id, 1, 'First Name', '', '',1, 1);
        $field_last_id = $this->create_template_text_field($form_id, 1, 'Last Name', '', '',1, 2);
        ...
        //Teacher Details
        $field_tfirst_id = $this->create_template_text_field($form_id, 1, 'First Name', '', '',1, 1);
        $field_tlast_id = $this->create_template_text_field($form_id, 1, 'Last Name', '', '',1, 2);
    ...
    public function create_contact_template_c13($form_id){
        ...
        $field_c_first_id = $this->create_template_text_field($form_id, 1, "Candidate's first name", '', '',1, 7);
        $field_c_last_id = $this->create_template_text_field($form_id, 1, "Candidate's last name", '', '',1, 8);
        $this->create_template_row_structure($form_id, array($field_c_first_id, $field_c_last_id), 1, '1:1',null,'Referral Information:');
        //Email
        $field_c_email_id = $this->create_template_normal_email_field($form_id, 1, 0, "Candidate's email ID" , '', 9);
    ...
    public function create_contact_template_c15($form_id){
        ...
        //Email
        $field_c_email_id = $this->create_template_normal_email_field($form_id, 1, 0, "Email" , '', 19);
        $this->create_template_row_structure($form_id, array($field_c_email_id), 1, '1');
        ...
        $field_c_email_id = $this->create_template_normal_email_field($form_id, 1, 0, "Email" , '', 27);
        $this->create_template_row_structure($form_id, array($field_mobile_id, $field_c_email_id), 1, '1:1');
        // Medical Concerns
...
2. I understand that HR reserves all the right to ask for more information or documents wherever required.','I agree');
    ...
    public function create_contact_template_cp3($form_id){
        ...
        //Email
        $field_email_id = $this->create_template_normal_email_field($form_id, 1, 0, 'Email' , '', 10);
        $this->create_template_row_structure($form_id, array($field_email_id), 1, '1');
        //Mobile
    ...
    public function create_template_normal_email_field($form_id, $page_no=1, $delete=0 ,$field_label='Email', $placeholder='', $order=1) {
        $field = new RM_Fields;
        $field->set(array('form_id' => $form_id,
            'field_type' => 'Email',
            'page_no' => $page_no,
