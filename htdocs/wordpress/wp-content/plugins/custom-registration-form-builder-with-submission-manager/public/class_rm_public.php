...
class RM_Public {
    ...
    public function enqueue_scripts() {
        ...
        if(isset($_GET['action']) && $_GET['action']=='registrationmagic_embedform' && defined('REGMAGIC_ADDON')){
            ...
            //wp_enqueue_script("rm_mobile_data_script", RM_BASE_URL . "public/js/mobile_field/data.min.js");
    ...
    public function send_activation_link(){
        if(check_ajax_referer('rm_send_verification_nonce','activation_nonce')) {
