                            ...
                            <div class="rm-user-card">
                                ...
                                <div class="rm-user-name-submission">
                                    ...
                                    <div class="rm-user-name-subtitle dbfl">
                                        <span data-rm_apply_acc_color='true'><?php echo esc_html($data->total_submission_count); ?> </span> <?php echo wp_kses_post((string)RM_UI_Strings::get('LABEL_REGISTRATIONS')); ?>.
                                    </div>
                                </div>
                            </div>
                        </div>
